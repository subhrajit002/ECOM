...
const confirmOrder = async (orderId) => {
    try {
        ...
        throw new Error("Order is not confirmed; something went wrong: " + error.message);
    }
}
...
const shiftOrder = async (orderId) => {
    try {
        ...
        throw new Error("Order is not SHIPPED; something went wrong: " + error.message);
    }
}
...
const deliveredOrder = async (orderId) => {
    try {
        ...
        throw new Error("Order is not DELIVERED; something went wrong: " + error.message);
    }
}
...
const cancelledOrder = async (orderId) => {
    try {
        ...
        throw new Error("Order is not CANCELLED; something went wrong: " + error.message);
    }
}
...
export default { createOrder, userOrderHistoryS, deleteCustomer, findOrderById, deleteOrder, getAllOrders, placedOrder, confirmOrder, shiftOrder, userOrderHistory, deliveredOrder, cancelledOrder };
