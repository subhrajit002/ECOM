    ...
    return (
        <div className='px-5 lg:px-20'>
            <Grid container spacing={2}>
                        ...
                        <div className="space-y-4 mt-10">
                            ...
                            {orderStatus.map((option) =>
                                <div className='flex items-center' key={option.value}>
                                    <input type="checkbox" className='h-4 w-4 border-gray-300 text-gray-900 focus:ring-gray-800' defaultValue={option.value} />
                ...
                <Grid item xs={12} sm={8.5} sx={{ marginLeft: { sm: '3rem', xs: '0' } }}>
